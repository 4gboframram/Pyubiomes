...
nether_biomes=[Biomes.nether_wastes, Biomes.crimson_forest]
...
def finder(start, increment):
	...
	while True:
		...
		structurecheck=structure_in_area(structure, seed, -128, -128, 128, 128, 16)
		print(seed)
		if structurecheck:
			if is_valid_structure_pos(structure, seed, *structurecheck, 16):
				biomecheck=biomes_in_area(wanted, seed, -128, -128, 128, 128, 16) and Pyubiomes.nether_biomes_in_area(seed, nether_biomes,-128, -128, 128, 128)
				if biomecheck: 
...
#PyuMap(-5332437328450840283, -16, -16, 32, 32, 4, 16, "mushroom_village").save().toPNG()
